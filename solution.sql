...
UPDATE syntax_practice set account_balance=10.00 where account_balance=10.00 AND transactions_attempted=0;
...
-- 8. Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('amy', 'minneapolis', 2, 4, 0);
